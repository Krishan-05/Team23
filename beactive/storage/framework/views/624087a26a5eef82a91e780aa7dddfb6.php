...
<head>
    ...
    <style>
        ...
        #grid-title {
            font-family: 'Space Grotesk', sans-serif; /* Matches the chosen font */
            font-size: 36px; /* Larger font size for prominence */
            font-weight: 700; /* Bold for emphasis */
            color: #007bff; /* Eye-catching blue to match the theme */
...
.product {
    ...
    border: 1px solid #e6e6e6; /* Subtle border to define edges */
    border-radius: 12px; /* Slightly rounded */
    padding: 20px;
    transition: transform 0.3s ease, box-shadow 0.3s ease, background-color 0.3s ease;
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.08); /* Gentle shadow for depth */
    max-width: 240px; /* Restrict product card width for uniformity */
    text-align: center;
    margin: 15px auto; /* Center products and add spacing */
...
.product:hover {
    ...
    background-color: #f9f9f9; /* Soft gray background on hover */
}

.product img {
    width: 140px; /* Ideal size for product images */
    height: auto;
    margin-bottom: 12px;
...
.product p {
    margin: 10px 0 5px;
    font-size: 17px; /* Perfect size for readability */
    font-weight: 600; /* Enhance visibility of product names */
    color: #333333; /* Dark text for strong contrast */
    text-align: center;
}

.product-price {
    font-size: 16px; /* Adjust size for emphasis */
    font-weight: 500; /* Medium weight for hierarchy */
    color: #007bff; /* Attractive blue tone for pricing */
    margin: 5px 0;
}
...
.product-button, .add-to-basket {
    ...
    border: none;
    padding: 10px 20px;
    border-radius: 25px; /* Fully rounded buttons for a modern feel */
    font-size: 14px;
    font-weight: 600;
    cursor: pointer;
...
.product-button:active,.add-to-basket:active{
    ...
    transform: scale(1); /* Remove scale for pressed state */
...
#searchBar {
    ...
    padding: 12px 20px; /* Spacious padding for comfort */
    font-size: 16px; /* Readable text size */
    border: 1px solid #e6e6e6; /* Subtle border matching product cards */
...
#searchBar:focus {
    ...
    box-shadow: 0 8px 15px rgba(0, 123, 255, 0.2); /* Optional shadow on focus */
}

#searchBar::placeholder {
    color: #999999; /* Subtle placeholder color */
    font-style: italic; /* Different style for placeholder */
}
...
<body>
   ...
   <div class="container">
            <div class="grid-container">
                ...
                <div class="product" id="item<?php echo e($mainProduct->id); ?>">
                    <!-- Product Image -->
                    <img src="<?php echo e(asset('images/sports equipment/' . strtolower(str_replace(' ', '-', $mainProduct->name)) . '.jpeg')); ?>" alt="<?php echo e($mainProduct->name); ?>" width="100">
                    <!-- Product Name -->
                    <p><?php echo e($mainProduct->name); ?></p>
                    <!-- Product Price -->
                    <p class="product-price">£<?php echo e($mainProduct->price); ?></p>
                    <!-- Add to Basket Button -->
                    <label for="quantity-<?php echo e($mainProduct->id); ?>" style="padding-bottom: 10px;">Quantity:</label>
                    <input type="number" id="quantity-<?php echo e($mainProduct->id); ?>" data-id="<?php echo e($mainProduct->id); ?>" data-name="<?php echo e($mainProduct->name); ?>" data-price="<?php echo e($mainProduct->price); ?>" class="quantity-input" min="1" max="100" value="1" style = "text-align: center;">
                    <button class="add-to-basket" data-id="<?php echo e($mainProduct->id); ?> ">Add to Basket</button>
                </div>
...
</html><?php /**PATH C:\Users\chris\repos\Team23\beactive\resources\views/supplements.blade.php ENDPATH**/ ?>