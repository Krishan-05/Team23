...
<head>
    ...
    <style>
        ...
        .product img {
            ...
            padding: 20px;
            max-width: 1600px;
            /* Increase size but keep responsiveness */
            max-height: 1600px;
        ...
        .quantity-input {
            ...
            width: 60px;
            height: 40px;
            /* Make it square for better alignment */
            background-color: #f8f8f8;
            ...
            border: 2px solid #007bff;
            /* Optional for improved appearance */
            border-radius: 8px;
            /* Softens the corners */
        }
        ...
        .add-to-basket:hover {
            ...
            background-color: rgb(39, 96, 157);
        ...
        .review-textbox {
            ...
            text-align: center;
            resize: none;
            /* Prevents resizing for a cleaner layout */
        }
...
<body>
    <main>
        ...
        <div class="product" id="item{{ $mainProduct->id }}" data-price="{{ $mainProduct->price }}"
            ...
            <!-- Add to Basket Button -->
            <label for="quantity-{{ $mainProduct->id }}" class="quantity-label"
                style="padding-bottom: 10px;">Quantity:</label>
            <div class="quantity-container">
                ...
                <input type="text" id="quantity-{{ $mainProduct->id }}" class="quantity-input"
                    ...
                    data-price="{{ $mainProduct->price }}" data-rating="{{ $mainProduct->rating }}" value="1" readonly>
                ...
                <div id="reviewPopup" class="modal">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('reviews.store') }}" method="POST">
                            ...
                            <input type="text" class="review-name-text" name="customer_name" id="customer_name"
                            ...
                            <textarea name="comment" class="review-textbox" id="comment"
                                placeholder="Write your review here..." rows="4" required></textarea><br>
