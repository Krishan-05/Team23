...
<body>
    ...
    <div class="contact-container">
        <div class="centerform">
            ...
            <form id="contactForm" onsubmit="return handleFormSubmit(event)">
                ...
                <br><input type="confirm_email" name="confirm_email" id="confirm_email" placeholder="Confirm Email"
                    required /><br>
                    ...
                    <p>
                        @auth
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit"
                                    style="border: none; background: none; color: inherit; font: inherit; cursor: pointer; padding: 0;">
                                    Logout
                                </button>
                            </form>
                        @else
    ...
    <script>
        function handleFormSubmit(event) {
            ...
            if (userConfirmation) {
                alert("Thank you for your message. It has been recieved by our team at beActive!");
                document.getElementById('contactForm').reset();
            } else {
                alert("Your message has not been sent. Feel free to send us any enquires you may have!");
            }
        }
    </script>
