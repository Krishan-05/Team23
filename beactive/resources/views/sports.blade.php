...
<head>
    ...
    <title>beActive - Sports Equipment</title> <!-- Title -->
    <style>
       .container {
            display: flex;
...
<body>
    ...
    <div class="container">
            <div class="grid-container">
                <!-- Title -->
                <div id="grid-title">Sports Equipment</div>
                ...
                <div class="product" id="item{{ $mainProduct->id }}">
                    <!-- Product Image -->
                    <img src="{{ asset('images/sports equipment/' . strtolower(str_replace(' ', '-', $mainProduct->name)) . '.jpeg') }}" alt="{{ $mainProduct->name }}" width="100">
                    <!-- Product Name -->
